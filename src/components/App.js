                ...
                <center>
                    <div className="margin-3">
                        <AutoComplete
                            ...
                            fullWidth={true}
                        />
                        <RaisedButton className="margin-3" label={(this.state.sort === "" && "Sort by Score") || (this.state.sort === "asc" && "Sort by Score(Low to High)") || (this.state.sort === "dsc" && "Sort by Score (High to Low)")} primary={true} onClick={this.sortbyscore} />
                    </div>
                </center>
